 ...
 */
class TEST_API_EXPORT ITestApi5
{
public:
 ...
 */
class TEST_API_EXPORT ITestApi5Subscriber
{
public:
 ...
 *  - subscribing with a IITestApi5Subscriber objects - for all of the changes
 ...
 */
class TEST_API_EXPORT ITestApi5Publisher
{
public:
