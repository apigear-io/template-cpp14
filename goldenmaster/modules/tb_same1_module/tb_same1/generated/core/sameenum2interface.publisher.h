 ...
 * see SameEnum2InterfacePublisherImpl for the implementation.
 * 
 */
...
public:
    ...
    virtual ~SameEnum2InterfacePublisher() = default;
...
private:
    std::unique_ptr<ISameEnum2InterfacePublisher> m_impl;
};
