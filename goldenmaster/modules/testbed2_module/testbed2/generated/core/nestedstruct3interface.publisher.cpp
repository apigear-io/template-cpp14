...
long ::subscribeToProp1Changed(NestedStruct3InterfaceProp1PropertyCb callback)
{
...
void ::publishProp1Changed(const NestedStruct1& prop1) const
{
...
long ::subscribeToProp2Changed(NestedStruct3InterfaceProp2PropertyCb callback)
{
...
void ::publishProp2Changed(const NestedStruct2& prop2) const
{
    for(const auto& subscriber: m_allChangesSubscribers)
    {
...
long ::subscribeToProp3Changed(NestedStruct3InterfaceProp3PropertyCb callback)
{
...
void ::publishProp3Changed(const NestedStruct3& prop3) const
{
    for(const auto& subscriber: m_allChangesSubscribers)
    {
...
long ::subscribeToSig1(NestedStruct3InterfaceSig1SignalCb callback)
{
...
void ::publishSig1(const NestedStruct1& param1) const
{
    for(const auto& subscriber: m_allChangesSubscribers)
    {
...
long ::subscribeToSig2(NestedStruct3InterfaceSig2SignalCb callback)
{
    // this is a short term workaround - we need a better solution for unique handle identifiers
...
void ::publishSig2(const NestedStruct1& param1,const NestedStruct2& param2) const
{
    for(const auto& subscriber: m_allChangesSubscribers)
    {
...
long ::subscribeToSig3(NestedStruct3InterfaceSig3SignalCb callback)
{
    // this is a short term workaround - we need a better solution for unique handle identifiers
...
void ::publishSig3(const NestedStruct1& param1,const NestedStruct2& param2,const NestedStruct3& param3) const
{
    for(const auto& subscriber: m_allChangesSubscribers)
    {
