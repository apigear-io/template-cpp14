...
public:
    ...
    */
    ...
    /**
    * @return Publisher class INestedStruct2InterfacePublisher responsible for clients subscribtion and notification.
    */
...
/**
 * The INestedStruct2InterfacePublisher provides an api for clients to subscribe to or unsubscribe from a signal emision 
 * or a property change.
 * Implement this interface to keep track of clients of your INestedStruct2Interface implementation.
 * The second part of the INestedStruct2InterfacePublisher interface is the notification interface.
 * It needs to be called by implementation of the INestedStruct2Interface on each state changed or signal emited
...
public:
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.Invoked by the NestedStruct2Interface implementation.
    ...
    */
    ...
    /**
    * Publishes the emited singal to all subscribed clients. Invoked by the NestedStruct2Interface implementation.
    * @param param1 
    */
