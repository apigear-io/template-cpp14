...
*/
    explicit NestedStruct2InterfaceService(INestedStruct2Interface& NestedStruct2Interface, ApiGear::ObjectLink::RemoteRegistry& registry);
...
public:
    ...
    */
    ...
    /**
    * Applies recived method invocation with given arguments on a NestedStruct2Interface object.
