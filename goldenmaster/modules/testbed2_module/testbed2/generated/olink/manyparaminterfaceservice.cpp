...
nlohmann::json ManyParamInterfaceService::olinkInvoke(std::string fcnName, nlohmann::json fcnArgs) {
...
void ManyParamInterfaceService::olinkSetProperty(std::string name, nlohmann::json value) {
...
void ManyParamInterfaceService::olinkLinked(std::string name, ApiGear::ObjectLink::IRemoteNode *node) {
    std::clog << name << std::endl;
    m_node = node;
}

void ManyParamInterfaceService::olinkUnlinked(std::string name)
{
    std::clog << name << std::endl;
    m_node = nullptr;
}
