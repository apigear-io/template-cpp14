...
*/
    explicit ManyParamInterfaceService(IManyParamInterface& ManyParamInterface, ApiGear::ObjectLink::RemoteRegistry& registry);
...
public:
    ...
    */
    ...
    /**
    * Applies recived method invocation with given arguments on a ManyParamInterface object.
