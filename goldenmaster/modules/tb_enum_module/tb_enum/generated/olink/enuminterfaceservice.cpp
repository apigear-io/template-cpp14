...
nlohmann::json EnumInterfaceService::olinkInvoke(std::string fcnName, nlohmann::json fcnArgs) {
...
void EnumInterfaceService::olinkSetProperty(std::string name, nlohmann::json value) {
...
void EnumInterfaceService::olinkLinked(std::string name, ApiGear::ObjectLink::IRemoteNode *node) {
    std::clog << name << std::endl;
    m_node = node;
}

void EnumInterfaceService::olinkUnlinked(std::string name)
{
    std::clog << name << std::endl;
    m_node = nullptr;
}
