...
*/
    explicit EnumInterfaceService(IEnumInterface& EnumInterface, ApiGear::ObjectLink::RemoteRegistry& registry);
...
public:
    ...
    */
    ...
    /**
    * Applies recived method invocation with given arguments on a EnumInterface object.
