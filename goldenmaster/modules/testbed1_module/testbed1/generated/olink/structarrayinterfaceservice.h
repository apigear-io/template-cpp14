...
*/
    explicit StructArrayInterfaceService(IStructArrayInterface& StructArrayInterface, ApiGear::ObjectLink::RemoteRegistry& registry);
...
public:
    ...
    */
    ...
    /**
    * Applies recived method invocation with given arguments on a StructArrayInterface object.
