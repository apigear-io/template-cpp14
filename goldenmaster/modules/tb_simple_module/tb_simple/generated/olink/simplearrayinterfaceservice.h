...
*/
    explicit SimpleArrayInterfaceService(ISimpleArrayInterface& SimpleArrayInterface, ApiGear::ObjectLink::RemoteRegistry& registry);
...
public:
    ...
    */
    ...
    /**
    * Applies recived method invocation with given arguments on a SimpleArrayInterface object.
