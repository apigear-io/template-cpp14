...
int main(){
    ...
    clientManager.connectAndLinkObject(testbed2ManyParamInterface);
    ...
    clientManager.connectAndLinkObject(testbed2NestedStruct1Interface);
    ...
    clientManager.connectAndLinkObject(testbed2NestedStruct2Interface);
    ...
    clientManager.connectAndLinkObject(testbed2NestedStruct3Interface);
    ...
    clientManager.connectAndLinkObject(tbEnumEnumInterface);
    ...
    clientManager.connectAndLinkObject(tbSame1SameStruct1Interface);
    ...
    clientManager.connectAndLinkObject(tbSame1SameStruct2Interface);
    ...
    clientManager.connectAndLinkObject(tbSame1SameEnum1Interface);
    ...
    clientManager.connectAndLinkObject(tbSame1SameEnum2Interface);
    ...
    clientManager.connectAndLinkObject(tbSame2SameStruct1Interface);
    ...
    clientManager.connectAndLinkObject(tbSame2SameStruct2Interface);
    ...
    clientManager.connectAndLinkObject(tbSame2SameEnum1Interface);
    ...
    clientManager.connectAndLinkObject(tbSame2SameEnum2Interface);
    ...
    clientManager.connectAndLinkObject(tbSimpleSimpleInterface);
    ...
    clientManager.connectAndLinkObject(tbSimpleSimpleArrayInterface);
    ...
    clientManager.connectAndLinkObject(testbed1StructInterface);
    ...
    clientManager.connectAndLinkObject(testbed1StructArrayInterface);
    ...
    clientManager.disconnectAndUnlink(testbed2ManyParamInterface->olinkObjectName());
    clientManager.disconnectAndUnlink(testbed2NestedStruct1Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(testbed2NestedStruct2Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(testbed2NestedStruct3Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbEnumEnumInterface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame1SameStruct1Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame1SameStruct2Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame1SameEnum1Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame1SameEnum2Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame2SameStruct1Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame2SameStruct2Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame2SameEnum1Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSame2SameEnum2Interface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSimpleSimpleInterface->olinkObjectName());
    clientManager.disconnectAndUnlink(tbSimpleSimpleArrayInterface->olinkObjectName());
    clientManager.disconnectAndUnlink(testbed1StructInterface->olinkObjectName());
    clientManager.disconnectAndUnlink(testbed1StructArrayInterface->olinkObjectName());
